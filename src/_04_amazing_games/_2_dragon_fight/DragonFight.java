...
public class DragonFight {
	...
	static void playerLost() {
		// 11. Tell the player that they have been defeated by the draon and have no treasure
		JOptionPane.showMessageDialog(null, "player have Lost");
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "dragon heve Lost, you won a ton of gold" );
