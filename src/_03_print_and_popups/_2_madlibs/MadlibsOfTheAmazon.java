...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adj=JOptionPane.showInputDialog("interradjective");
		// Get the player to enter a type of liquid
		String alq=JOptionPane.showInputDialog("interradliquid");
		// Get the player to enter a body part
		String part=JOptionPane.showInputDialog("interradPart");
		// Get the player to enter a verb
		String verb=JOptionPane.showInputDialog("interradverb");
		// Get the player to enter a place
		String place=JOptionPane.showInputDialog("interradverb");
		...
		"night. Piranhas are attracted to fresh "+ alq+" and will most\n"  +
